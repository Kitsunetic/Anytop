...
def main(args=None, cond_dict=None):
    ...
    for rep_i in range(args.num_repetitions):
        ...
        for i, motion in enumerate(sample):
            ...
            joint2color = {
                frame: {joint: 0 if inpaint_mask[joint, frame] else 1 for joint in range(n_joints)} for frame in range(n_frames)
            }
            ...
            data = {"motion": motion, "joint2color": joint2color, "sample_path": args.samples[i]}
