...
OBJECT_SUBSETS_DICT = {
    "all": QUADROPEDS + BIPEDS + MILLIPEDS + SNAKES + FISH + FLYING,
...
FACE_JOINTS = {
    "Alligator": [8, 11, 17, 20],
    "Crow": [18, 21, 7, 11],
    "Anaconda": [13, 26, 13, 26],
    "Ant": [9, 15, 23, 30],
    "Bat": [6, 15, 26, 34],
    "Bear": [8, 2, 36, 56],
    "Bird": [15, 35, 6, 11],
    ...
    "Goat": [24, 19, 14, 8],
    "Hamster": [3, 9, 19, 25],
    "HermitCrab": [51, 46, 8, 12],
    "Hippopotamus": [5, 11, 28, 34],
    "Horse": [10, 16, 33, 41],
    "Hound": [3, 9, 19, 25],
    "Isopetra": [48, 55, 18, 26],
    "Jaguar": [6, 12, 22, 28],
    "KingCobra": [6, 7, 6, 7],
    "Leapord": [7, 13, 25, 31],
    "Lion": [6, 11, 19, 24],
    ...
    "Pirrana": [19, 20, 4, 5],
    "PolarBear": [3, 9, 19, 25],
    "PolarBearB": [3, 8, 17, 23],
    "Pteranodon": [16, 5, 40, 35],
    "Puppy": [5, 11, 20, 26],
    "Raindeer": [3, 9, 18, 24],
    "Raptor": [13, 19, 13, 19],
    "Raptor2": [52, 40, 23, 13],
    ...
    "Rhino": [5, 11, 21, 27],
    "Roach": [2, 6, 29, 25],
    "SabreToothTiger": [7, 2, 37, 51],
    "SandMouse": [7, 13, 30, 34],
    "Scorpion": [58, 29, 20, 25],
    "Scorpion-2": [55, 23, 48, 16],
    "Skunk": [10, 15, 28, 32],
    "Spider": [21, 27, 5, 9],
    "SpiderG": [13, 19, 27, 33],
    "Stego": [7, 12, 27, 21],
