...
SUBSET_TO_LOCATION = {
    "bipeds": Vector((-1.58, 0.1379864662885666, 0.04131503775715828)),
    "flying": Vector((-1.58, 0.137, -0.2)),
    "millipeds_snakes": Vector((-2, 0.1379864662885666, 0.08)),
    "quadropeds": Vector((-1.58, 0.1379864662885666, 0.04131503775715828)),
}
